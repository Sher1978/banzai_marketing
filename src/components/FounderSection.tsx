...
const FounderSection: React.FC = () => {
    ...
    return (
        <section className="relative py-16 md:py-32 px-6 bg-dubai-night border-y border-primary/20 overflow-hidden">
            {/* HUD Grid Overlay */}
            ...
            <div className="max-w-[1280px] mx-auto mt-24 p-6 md:p-12 border border-white/5 bg-black/40 backdrop-blur-xl relative z-10 sharp-border shadow-neon-glow overflow-hidden">
                {/* Glowing neon borders & background volumetric gradient */}
                <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-primary/30 to-transparent z-0" />
                <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-secondary/30 to-transparent z-0" />
                <div className="absolute -inset-20 bg-[radial-gradient(circle_at_center,rgba(6,182,212,0.06)_0%,transparent_60%)] pointer-events-none z-0" />
                <div className="absolute -inset-20 bg-[radial-gradient(circle_at_center,rgba(168,85,247,0.04)_20%,transparent_75%)] pointer-events-none z-0" />
