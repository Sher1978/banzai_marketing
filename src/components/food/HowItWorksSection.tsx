...
export default function HowItWorksSection() {
  const steps = [
    ...
    },
    {
      step: "04",
      icon: Receipt,
      title: "4. Отчетность 2 раза в месяц и оплата 10%",
      subtitle: "Оплата только за реальный результат",
      text: "Каждые 15 дней мы формируем прозрачный отчет Grabix с выпиской всех продаж и чистого чека. Вы платите 10% ТОЛЬКО с нового чистая прироста вашей прибыли. Нет роста — комиссия 0%.",
      badge: "Шаг 4 • 10% с прироста",
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm font-medium">
                Наша агентская комиссия 10% рассчитывается исключительно от нового дельта-роста вашей
