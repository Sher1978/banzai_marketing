...
export const FomoSlider: React.FC = () => {
    ...
    const slides = [
        {
            id: 0,
            categoryRu: 'Кризис Рекламы 2026',
            categoryEn: 'Ad Crisis 2026',
            titleRu: 'Стоимость клика уже выше вашей прибыли. Реклама выжигает бюджет.',
            titleEn: 'Cost per click exceeds your profit margin. Ads are burning your budget.',
            quoteRu: 'Google Ads дорожает на 10-12% в год из-за ИИ-выдачи (AI Overviews). В Meta Ads CPM вырос на 20%, а цена клиента (CPA) в B2B доходит до $300+. Покупать клики больше нерентабельно — вам нужно получать клиентов в обход аукционов.',
            quoteEn: 'Google Ads CPC grows 10-12% annually due to AI Overviews. Meta Ads CPM surged 20%, and B2B CPA reaches $300+. Buying clicks is no longer profitable — you must acquire clients by bypassing ad auctions.',
            ctaRu: 'Разобрать показатели моей ниши',
            ctaEn: 'Analyze My Niche Metrics',
            icon: Flame,
            badgeRu: 'АУКЦИОННЫЙ КРИЗИС',
            badgeEn: 'AUCTION CRISIS',
            statRu: 'Недвижимость, медицина и B2B: рост клика до +27.3%',
            statEn: 'Real Estate, Medical, B2B: CPC growth up to +27.3%',
            image: '/assets/cpc_danger_chart.png',
            overlayTitleRu: '🚨 РОСТ ЦЕНЫ ЗА КЛИК',
            overlayTitleEn: '🚨 CPC COST SURGE',
            overlayTextRu: 'CPA в e-commerce $35–$65, в B2B $300+',
            overlayTextEn: 'E-com CPA $35-$65, B2B CPA $300+',
            overlayHighlightRu: '📉 Традиционная реклама убыточна',
            overlayHighlightEn: '📉 Traditional ads are losing money',
            overlayTag: 'AD COSTS'
        },
        {
            id: 1,
    ...
    return (
        <section id="fomo" className="relative py-10 md:py-16 px-3 sm:px-6 bg-structural-mesh border-b border-white/10 overflow-hidden">
            {/* Cyber Grid */}
